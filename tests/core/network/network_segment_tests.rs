...
async fn test_window_calculation_cold() {
    ...
    let decision = segment
        .calculate_window_decision(&input, None)
        .await
        .unwrap();
...
async fn test_phase1_single_jsonl_scan() {
    ...
    let window_decision = segment
        .calculate_window_decision(&input, Some(true))
        .await
        .unwrap();
...
async fn test_phase2_window_deduplication() {
    ...
    let decision_1 = segment
        .calculate_window_decision(&input_green_1, Some(false))
        .await
        .unwrap();
    ...
    let decision_2 = segment
        .calculate_window_decision(&input_red_1, Some(true))
        .await
        .unwrap();
    ...
    let decision_3 = segment
        .calculate_window_decision(&input_green_2, Some(false))
        .await
        .unwrap();
...
async fn test_phase3_cold_state_validation() {
    ...
    let mut segment_mut =
        NetworkSegment::with_state_path(temp_dir.path().join("test_state2.json")).unwrap();
    let decision = segment_mut
        .calculate_window_decision(&input_cold, None)
        .await
        .unwrap();
    ...
    let decision_non_cold = segment_mut
        .calculate_window_decision(&input_non_cold, Some(false))
        .await
        .unwrap();
...
async fn test_enhancement_window_priority() {
    ...
    let decision = segment
        .calculate_window_decision(&input_cold, Some(true))
        .await
        .unwrap();
    ...
    let decision_both = segment
        .calculate_window_decision(&input_both, Some(true))
        .await
        .unwrap();
...
async fn test_window_decision_struct() {
    ...
    let decision_green = segment
        .calculate_window_decision(&input_green_only, Some(false))
        .await
        .unwrap();
...
async fn test_enhancement_error_handling() {
    ...
    let decision = segment
        .calculate_window_decision(&input_zero, None)
        .await
        .unwrap();
    ...
    let decision_large = segment
        .calculate_window_decision(&input_large, Some(false))
        .await
        .unwrap();
