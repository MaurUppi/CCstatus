...
impl CurlGetRunner {
    ...
    pub async fn get_health_with_timings(
        ...
        let result = tokio::task::spawn_blocking(
            move || -> Result<(HealthResponse, PhaseTimings), String> {
                ...
                handle
                    .get(true)
                    .map_err(|e| format!("GET method failed: {}", e))?; // GET method
                handle
                ...
                handle
                    .cookie_file("")
                    .map_err(|e| format!("Cookie engine failed: {}", e))?; // In-memory cookies
